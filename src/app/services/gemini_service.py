    ...
    async def generate_response(
        ...
        try:
            ...
            if "429" in error_msg or "quota" in error_msg.lower():
                print(f"⚠️  Gemini quota exceeded. Using simulated response.")
...
5. Referencia específicamente las partes del contexto que usas en tu respuesta
...
Respuesta basada EXCLUSIVAMENTE en el contexto universitario:"""
            ...
            # Si no hay contexto, ser explícito
...
Respuesta:"""
    ...
    async def _generate_with_pdf(
        ...
        try:
            print(f"📄 Downloading PDF from MinIO: {context_file_path}")
...
6. Referencia específicamente las partes del documento que usas
...
Respuesta basada EXCLUSIVAMENTE en el documento PDF universitario:"""
    ...
    async def _generate_with_gemini_and_file(self, prompt: str, uploaded_file) -> str:
        ...
        try:
            ...
            print(f"❌ Error generating with Gemini and file: {e}")
            raise
    ...
    async def _generate_with_gemini(self, prompt: str) -> str:
        ...
        try:
            ...
            print(f"❌ Error en la generación con Gemini: {e}")
            raise
